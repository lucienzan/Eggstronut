...
<nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom position-fixed top-0 w-100">
    <div class="container">
        <a class="navbar-brand d-flex align-items-center justify-content-center" href="{{ route('index') }}">
            <img src="{{ asset('favicon.png') }}" style="height: 40px" class="me-1" alt="">
            <h3>EGGstronut</h3>
        </a>
                    ...
                    <div id="search" class="mb-5">
                        <form action="{{ route('index') }}" method="get">
                            <div class="d-flex search-box">
                                <input type="text" name="keyword" class="form-control flex-shrink-1 me-2 search-input" placeholder="Search Anything">
